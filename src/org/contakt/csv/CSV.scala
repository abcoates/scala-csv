...
/**
 * Scala CSV parser, as posted by Paul Phillips on Stack Overflow.  See http://stackoverflow.com/questions/5063022/use-scala-parser-combinator-to-parse-csv-files
 */
